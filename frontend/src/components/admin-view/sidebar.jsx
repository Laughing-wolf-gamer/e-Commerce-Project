        ...
        <nav className='mt-8 flex flex-col gap-2'>
            {
                adminSideBarMenu.map((item) => (
                        <div key={item.id} className='flex cursor-pointer hover:bg-muted hover:text-foreground items-center gap-2 rounded-md py-2' itemType='button' onClick={()=> navigate(item?.path)}>
